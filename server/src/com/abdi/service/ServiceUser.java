...
import com.abdi.connection.DatabaseConnection;
...
public class ServiceUser {
    ...
    public Model_Message register(Model_Register data){
        ...
        try {
            PreparedStatement p = connection.prepareStatement(CKECK_USER);
    ...
    public List <Model_User_Account> getUser(int exitUser)throws Exception {
    ...
    private final String CKECK_USER = "select UserID from user where UserName =? limit 1";
